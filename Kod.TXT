...
//        }
    ...
    JMenuBar createMenuBar() {
       ...
       Hakkinda3.addActionListener(new ActionListener() {
           public void actionPerformed(ActionEvent ae) {
               JOptionPane.showMessageDialog(null,"Öğrenci No : 170541612 \nÖğrenci Adı : Badour alkhateb ","Öğrenci Bilgisi", JOptionPane.PLAIN_MESSAGE);
           }
       });
       about.add(Hakkinda);
       about.add(Hakkinda2);
